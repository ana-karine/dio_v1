...
public class ExercicioProposto01 {
    public static void main(String[] args) {
        ...
        for (int i = 1; i <= 6; i++) {
            ...
            temperaturasSemestre.add(temp);
            soma += temp;
        }

        double mediaTemperaturasSemenstre = soma/temperaturasSemestre.size();

        System.out.println("Temperaturas Semestre: " + temperaturasSemestre);
        System.out.println("Média temperaturas Semestre: " + mediaTemperaturasSemenstre + " oC");
        System.out.println("----------");

        for (Double temp : temperaturasSemestre) {
            if(temp > mediaTemperaturasSemenstre) {
                int index = temperaturasSemestre.indexOf(temp);
