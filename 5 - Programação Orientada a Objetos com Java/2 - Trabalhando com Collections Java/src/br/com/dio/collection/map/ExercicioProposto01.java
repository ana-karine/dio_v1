...
/*
Dada a população estimada de alguns estados do nordeste brasileiro:
...
- Exiba todos os estados e suas populaçãos na ordem em que foram adicionados;
...
public class ExercicioProposto01 {
    public static void main(String[] args) {
        ...
        System.out.println("Exiba todos os estados e suas populaçãos na ordem em que foram adicionados: ");
        ...
        System.out.printf("Exiba o estado com a menor população e seu respectivo valor: \n",
                estadoMenorPopulacao, Collections.min(populacao));
        System.out.printf("Exiba o estado com a maior população e seu respectivo valor: \n",
...
*/
        ...
        System.out.println("Exiba a média da população desse dicionário de estados: " + (soma / populaçãoEstadosNE.size()));
